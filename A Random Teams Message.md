...
This is a "starter" style scenario. It plays through, but you will need to add some additional details throughout the game.  
...
Select any combination of 4 Procedure cards to be established procedures. I like to select 2-3 established procdedures that can solve more than one scenario cards. The remainder can solve one or none 🧌. 
...
## Scenario Brief
Who is invovled? Sales Manager, Tim
...
- In cases where ann 11 - 20 is rolled bt doesn't flip a card "Just because you are good at something doens't mean it always works out"  

## Card details
As your reponders flip cards, you should add additional details to the story  
...
- Pivot & Escalate- Malicious File Upload to Shared File Service: The user saw legitimate branding and logged in. At least they accessed a Excel file on something that looks like SharePoint. (Yes, this isn't a perfect fit, sometimes you need to use your immagination)  
